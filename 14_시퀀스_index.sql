...
CREATE SEQUENCE dept2_seq
   ...
   INCREMENT BY 1 -- 증가값 (양수면 증가, 음수면 감소, 기본값 1) 1이면 생략가능
   MAXVALUE 10 -- 최대값 (기본값은 증가일 때 1027, 감소일 때 -1)
   MINVALUE 1-- 최소값 (기본값 증가일 때 1, 갑소일 때 -1028)
...
CREATE TABLE dept2 (
    ...
    dept_mame VARCHAR2(14),
    loca VARCHAR2(13),
    dept_date DATE
);

-- 시퀀스 사용하기 (NEXTNAL, CURRVAL)
INSERT INTO dept2
...
ALTER SEQUENCE dept2_seq INCREMENT BY -36;
